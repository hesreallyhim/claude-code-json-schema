...
|---|---|---|---|---|---:|---|
| `plugin-name-kebab-case` | plugin | paired | `fixtures/synthetic/pass/plugin/minimal.json` | `fixtures/synthetic/fail/plugin/name-must-be-kebab-case.json` | 1 | CLI validates camelCase plugin names as pass. |
| `plugin-version-semver` | plugin | paired | `fixtures/synthetic/pass/plugin/version-allows-prerelease-semver.json` | `fixtures/synthetic/fail/plugin/version-must-be-semver.json` | 1 | CLI validates non-semver values like `1.0` as pass. |
...
| `marketplace-top-level-additional-properties-rejected` | marketplace | paired | `fixtures/synthetic/pass/marketplace/basic.json` | `fixtures/synthetic/fail/marketplace/no-additional-top-level-properties.json` | 1 | CLI validates unknown marketplace top-level keys as pass. |
